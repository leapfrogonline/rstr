...
class Xeger(object):
    ...
    def __init__(self) -> None:
        ...
        self._cases: Dict[str, Callable[[Any], Any]] = {
    ...
    def xeger(self, string_or_regex:  Type[Union[Pattern[AnyStr], str]]) -> str:
        parsed = re.sre_parse.parse(pattern)
        result: str = self._build_string(parsed)
        ...
    ...
    def _handle_repeat(self, start_range: int, end_range: int, value):
        result = []
